...
function calculateTax() {
  ...
  const tax = basicSalary - nssf- totalTax- nhifContribution; 
  
  
  // Display the result
  resultOutput.textContent = `Your PAYE tax is: ${totalTax.toFixed(2)}, your NHIF contribution is: ${nhifContribution} , your nssf is:${nssf} and your salary is:${tax.toFixed(2)}`;
}
